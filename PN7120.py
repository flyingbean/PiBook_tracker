...
_NFC_DEMO_APP_DEFAULT_LOCATION = '/home/sherry/NXP_NFC/linux_libnfc-nci'
...
class PN7120(object):
    ...
    pn7120.when_tag_read = text_callback
    ...
    Read Once
    =========
    text = pn7120.read_once()
    Write
    =====
    success = pn7120.write("some text")
    """
...
#pn7120 = PN7120()
#pn7120.when_tag_read = lambda text: print(text)
#pn7120.start_reading()
